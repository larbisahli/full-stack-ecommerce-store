...
const DrawerWrapper: React.FunctionComponent<DrawerWrapperProps> = ({
  ...
  return (
    <div className="flex flex-col h-full relative nav-side-background">
      <div
      ...
      >
        ...
        <button
          ...
          rounded text-body bg-gray-300 transition-all duration-200 
          focus:outline-none hover:bg-accent focus:bg-accent 
